...
int main(int argc, char* argv[])
{
    ...
    for(int i=0;i<CountProc;++i)
    {
                ...
                std::string cons = "D:\\Clion_projects\\Lab3\\cmake-build-debug\\kaka.exe "
                                   "D:\\Clion_projects\\Lab3\\matrix.txt " +
                std::to_string(lines) + " " +
                std::to_string(lines_per_process);
                CreateProcess("D:\\Clion_projects\\Lab3\\cmake-build-debug\\kaka.exe",
                              (LPSTR)cons.c_str() ,
                              nullptr,
                              nullptr,
                              FALSE,
